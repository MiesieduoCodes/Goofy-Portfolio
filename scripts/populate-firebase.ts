...
// Run with: npm run populate:firebase
...
async function populateDatabase() {
  ...
  try {
    ...
    if (!isConnected) {
      console.log("❌ Firebase database is not connected or accessible.");
      console.log("📋 Please check:");
      console.log("   1. Firebase Realtime Database is enabled in your project");
      console.log("   2. Database URL is correct");
      console.log("   3. Firebase rules allow read/write access");
